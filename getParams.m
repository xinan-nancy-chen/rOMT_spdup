...
switch data_name
    ...
    case 'MCA_S1' % 2D
        ...
        data_par.first_time = 50;
        data_par.time_jump = 16;
        data_par.last_time = 82;%98;
        
        model_par.sigma = 5e-1;
        model_par.sig_str = '5e1';
        model_par.dt = 0.4;
        model_par.nt = 10;
        model_par.gamma = 0.008;
        model_par.beta  = 0.0001;%0.0000001;%0.1;%0.0001;
        model_par.niter_pcg = 60;%40;%20;
    ...
    case 'gaussian3' % 2D
        ...
        path_par.data_name = 'gaussian3_wk';
        path_par.extension = '.mat';
        
        data_par.dataset_name = 'gaussian2D';

        
        data_par.domain_size = [50,50];
        
        data_par.x_range = 1:50;
        data_par.y_range = 1:50;
        ...
        data_par.first_time = 0;
        data_par.time_jump = 1;
        data_par.last_time = 0;
    ...
    %%
    case 'gaussian2' % 2D
        path_par.data_tag = 'gaussian2';
        path_par.data_dir = './data/gaussian2D/gaussian2/';
        path_par.data_name = 'gaussian2_wk';
        path_par.extension = '.mat';
    ...
    %%
    case 'gaussian1' % 2D
        path_par.data_tag = 'gaussian1';
        path_par.data_dir = './data/gaussian2D/gaussian1/';
        path_par.data_name = 'gaussian1_wk';
        path_par.extension = '.mat';
